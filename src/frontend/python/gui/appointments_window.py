"""
Appointments Window Module for MediSys Hospital Management System

This module implements the dedicated window for appointment management, including
functionality for scheduling, viewing, and managing appointments. It features a
calendar view, filtering options, and appointment details form for creating and
