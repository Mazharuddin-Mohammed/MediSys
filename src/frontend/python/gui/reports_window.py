"""
Reports Window Module for MediSys Hospital Management System

This module implements the dedicated window for generating and viewing various
reports, including patient reports, doctor reports, and financial reports. It
provides filtering options by date range and report type, as well as export
functionality.
